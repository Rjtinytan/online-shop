...
class SampleApp(tk.Tk):
    def __init__(self, *arg, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, MenuPage, Registration, Product, Search, Cart, Account, Aboutus, Help):
...
class MenuPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def get_template():
            controller.show_frame('Product')

        contact_button = tk.Button(self, text="Product", command=(get_template), font=('Candara', 10, 'bold'), fg='#292421', bg='#FFF0F5')
        contact_button.pack(pady=30)
        contact_button.place(x=30, y=10)

        def get_clothes():
            controller.show_frame('Search')

        contact_button = tk.Button(self, text="Search", command=(get_clothes), font=('Candara', 10, 'bold'), fg='#292421', bg='#FFF0F5')
        contact_button.pack(pady=30)
        contact_button.place(x=83, y=10)

        def get_subs():
            controller.show_frame('Cart')
...
class Product(tk.Frame):
    def __init__(self, parent, controller):
        ...
        big_lable = tk.Label(self, text='Product', font=('Candara', 50, 'bold'), fg='black', bg='white')
        big_lable.pack(pady=30)
...
class Search(tk.Frame):
    def __init__(self, parent, controller):
        ...
        big_lable = tk.Label(self, text='Search', font=('Candara', 50, 'bold'), fg='black', bg='white')
        big_lable.pack(pady=30)
        text = tk.Label(self, text='', font=('Candara', 12, 'bold'), fg='black', bg='white')
        text.pack(pady=30)
...
class Aboutus(tk.Frame):
    def __init__(self, parent, controller):
        ...
        big_lable = tk.Label(self, text='Company and Services', font=('Candara', 50, 'bold'), fg='black', bg='white')
        big_lable.pack(pady=30)
        text = tk.Label(self, text='', font=('Candara', 12, 'bold'), fg='black', bg='white')
        text.pack(pady=30)
